...
class ParticipantsPage(ctk.CTkToplevel):
    ...
    def __init__(self, parent):
        ...
        participants = [
            ("👨", "John Doe", "Host", "🟢 Online"),
            ("👩", "Sarah Johnson", "Presenter", "🟢 Online"),
            ("👨", "Michael Brown", "Participant", "🟢 Online"),
            ("👩", "Emily Davis", "Participant", "🟢 Online"),
            ("👨", "David Wilson", "Participant", "🟢 Online"),
            ("👩", "Sophia Martin", "Participant", "🟢 Online"),
            ("👨", "Daniel Clark", "Participant", "🟢 Online"),
            ("👩", "Emma Taylor", "Participant", "🟢 Online"),
        ]
