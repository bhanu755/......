...
class AnalyticsPage(ctk.CTkToplevel):
    ...
    def __init__(self, parent):
        ...
        self.card(stats, "Meetings", "126").grid(row=0, column=0, padx=15, pady=10)
        self.card(stats, "Participants", "84").grid(row=0, column=1, padx=15, pady=10)
        self.card(stats, "Hours", "312").grid(row=0, column=2, padx=15, pady=10)
        self.card(stats, "Success", "98%").grid(row=0, column=3, padx=15, pady=10)
